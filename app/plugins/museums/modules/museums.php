...
BaseModel::$s_ca_models_definitions['mana_museums'] = array(
 	...
 	'FIELDS' 			=> array(
		...
		'museum_name' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => _t('Museum name'), 'DESCRIPTION' => _t(''),
		...
		'museumclass' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => 0,
				'LABEL' => _t('Museum class'), 'DESCRIPTION' => _t('"Full" museum accounts may log into all CollectiveAccess interfaces. "Public" museum accounts may only log into the publicly accessible front-end system (if one exists). "Deleted" museums may not log into any interface – the account is considered removed.'),
		...
		'fname' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => _t('First name'), 'DESCRIPTION' => _t('The forename of this museum.'),
		...
		'lname' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => _t('Last name'), 'DESCRIPTION' => _t('The surname of this museum.'),
				'BOUNDS_LENGTH' => array(1,255)
		),
		'email' => array(
				'FIELD_TYPE' => FT_TEXT, 'DISPLAY_TYPE' => DT_FIELD, 
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => _t('E-mail'), 'DESCRIPTION' => _t('The e-mail address of this museum. The address will be used for all mail-based system notifications and alerts to this museum.'),
				'BOUNDS_LENGTH' => array(0,255)
		),
		'sms_number' => array(
				'FIELD_TYPE' => FT_TEXT, 'DISPLAY_TYPE' => DT_FIELD, 
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => _t('SMS number'), 'DESCRIPTION' => _t('Phone number for contact by SMS (text message). The number will be used for all SMS-based system notifications and alerts to this museum.'),
		...
		'entity_id' => array(
				...
				'IS_NULL' => true, 
				'DEFAULT' => '',
				'LABEL' => _t('Related entity (optional)'), 'DESCRIPTION' => _t('The entity this museum login is associated with.')
		),
		'vars' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => 'Museum variable storage', 'DESCRIPTION' => 'Storage area for museum variables'
		),
		'volatile_vars' => array(
				'FIELD_TYPE' => FT_VARS, 'DISPLAY_TYPE' => DT_OMIT, 
				'DISPLAY_WIDTH' => 88, 'DISPLAY_HEIGHT' => 15,
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => 'Volatile museum variable storage', 'DESCRIPTION' => 'Storage area for museum variables of limited size that change often'
		),
		'active' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => _t('Account is activated?'), "DESCRIPTION" => "If checked, indicates museum account is active. Only active museums are allowed to log into the system.",
...
class museums extends BaseModel {
	 ...
	 *
	 * Required fields are museum_name, fname and lname.
	 *
	 * @access public 
	 * @return bool Returns true if no error, false if error occurred
	 */	
	...
	public function getMuseumList($pa_options=null) {
		...
		$va_valid_sorts = array('lname,fname', 'museum_name', 'email', 'active');
	...
	public function museumListAsHTMLFormElement($pa_options=null) {
		...
		if (sizeof($va_museums)) {
			...
			foreach($va_museums as $vn_museum_id => $va_museum_info) {
				...
				$vs_buf .= "<option value='{$vn_museum_id}' {$SELECTED}>".$va_museum_info['fname'].' '.$va_museum_info['lname'].($va_museum_info['email'] ? " (".$va_museum_info['email'].")" : "")."</option>\n";
			}
			$vs_buf .= "</select>\n";
		}
