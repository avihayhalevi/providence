<?php
/* ----------------------------------------------------------------------
 * /views/administrate/access/museum_report_tab.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
 ...
 */
	...
	header("Content-Disposition: attachment; filename=museum_export_".$vs_download_format."_".date("m_d_y").".".$vs_file_extension);
