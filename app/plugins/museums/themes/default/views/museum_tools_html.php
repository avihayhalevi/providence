<?php
/* ----------------------------------------------------------------------
 * themes/default/views/administrate/access/museum_tools_html.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
 ...
 */
 ...
 # --- NOTE:  Can't use a form here because the entire museum list is wrapped in a form tag hence the js - forms within forms are a no-no
?>
<div id="searchToolsBox">
	<div class="bg">
	<div class="col">
<?php
		print _t("Download museum report as").":<br/>";
...
/* <![CDATA[ */
	var originalHref = "<?php print caNavUrl($this->request, $this->request->getModulePath(), $this->request->getController(), 'DownloadmuseumReport', array('download' => 1)); ?>";
